# Run Testem Tests on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Testem Tests across real browsers and operating systems.
